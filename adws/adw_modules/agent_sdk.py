...
async def query_with_tools(
    prompt: str, allowed_tools: List[str], working_dir: Optional[Path] = None
...
async def create_session(
    model: str = "claude-sonnet-4-20250514", working_dir: Optional[Path] = None
):
...
async def stream_with_progress(
    prompt: str, on_text: Optional[callable] = None, on_tool: Optional[callable] = None
) -> ResultMessage:
